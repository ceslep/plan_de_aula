<script lang="ts">
  ...
  const teachers = [
    ...
    "PABLO ESTEBAN REINOSO HENAO",
  ];
</script>

<select bind:value class="teacher-select">
...
<style>
  ...
  /* Style options for better visibility in some browsers */
  option {
    background-color: #242424;
    color: white;
  }
